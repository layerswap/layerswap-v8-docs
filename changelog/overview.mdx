...
<Update label="2024-12-12" description="v0.1.5-testnets">
    - Released Layerswap V8 [Bridge dApp](https://layerswap.io/v8) to use [Signature flow](/protocol-spec/core) instead of the user doing 2 transactions; the user now does 1 transaction and 1 signature.
</Update>
