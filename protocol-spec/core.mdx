...
<Tabs>
  <Tab title="Overview">
    The Core of the protocol relies on PreHTLC contract. This contract is responsible for locking and unlocking funds on conditions. The main functions are:
  ...
  <Tab title="Code">
    Implementation of the PreHTLC core contracts can be found at [V8 repo](https://github.com/layerswap/layerswap-atomic-bridge) for any VM blockchain, like [EVM](https://github.com/layerswap/layerswap-atomic-bridge/tree/main/chains/evm/solidity), [TON](https://github.com/layerswap/layerswap-atomic-bridge/tree/main/chains/ton/contracts), [Solana](https://github.com/layerswap/layerswap-atomic-bridge/tree/main/chains/solana), [Sui](https://github.com/layerswap/layerswap-atomic-bridge/tree/main/chains/SUI), Fuel and more.

    ```solidity
    contract LayerswapV8ERC20 {

        // Emitted when one party creates a HTLC, committing tokens for exchange with a specific party. Hop* fields are used for Multihop transactions.
