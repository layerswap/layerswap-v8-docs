---
title: 'LP Implementation'
description: 'Describes the protocol implementation for the LP'
icon: network-wired
---
...
<Steps>
  ...
  <Step title="Lock funds on the destination chain">
    ...
    - When a commitment is detected, call `lock()` on the destination chain and pass the generated `hashlock`.
  </Step>
  <Step title="Verify the commitment lock">
    ...
    - Verify that the updated `timelock` is at least 2x greater than the initial `timelock`.
  </Step>
