...
<Warning>
[Edge Case: Party 2 fails to act on commitment](edge-cases)
...
<Warning>
[Edge Case: Party 2 fails to release Party 1’s funds](edge-cases)
...
<Warning>
[Edge Case: Party 2 fails to release at all](edge-cases)
