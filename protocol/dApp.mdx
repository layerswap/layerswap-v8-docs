...
- Connect to the [Discovery registry](/protocol/discovery) and fetch available LPs/networks.
- Connect to the [Auction](/protocol/auction) to transmit the user's intent and get quotes from LPs.
- Execute an [Atomic Swap](/protocol/atomic-swaps-prehtlc) flow by locking assets and observing transactions on the destination chain through RPC or Light Client (e.g., [Helios](https://github.com/a16z/helios)).