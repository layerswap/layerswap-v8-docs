...
Layerswap V8 has an on-chain [Discovery Registry](/protocol-spec/discovery) for protocol metadata and LPs to ensure users, auctions, and integrators can discover liquidity providers (LPs). LPs will register their addresses and the routes they support.
