...
The Layerswap V8 protocol consists of **4** main components:
...
<Card title="The Discovery Contract" icon="lighthouse" horizontal="true" href="discovery">
...
<Card title="The Auction" icon="scale-balanced" horizontal="true" href="auction">
  This is a standard Dutch auction used by Liquidity Providers to compete for user requests.
</Card>

<Card title="PreHTLC Contracts" icon="file-lock" horizontal="true" href="atomic-swaps-prehtlc">
