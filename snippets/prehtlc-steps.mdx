<Steps>
  ...
  <Step title="Unlocks">
    Upon seeing this conversion, the LP reveals the Secret S on the source chain to claim their funds and then reveals the Secret S on the destination chain to release the user's funds - `redeem()`.
  </Step>
</Steps>